  ...
  return (
    <div className="mb-8">
        ...
        <div className="flex flex-row text-primaryBlue">
            <div className="mr-3 w-[517px] h-[101px] py-5 px-5 bg-cover bg-[url('assets/images/total_earned_bg.png')]">
            ...
            <div className='w-[161px] h-[101px] bg-primaryGreen py-6 px-3 rounded-lg mr-3'>
            ...
            <div className='w-[161px] h-[101px] bg-primaryGreen py-6 px-3 rounded-lg'>
