  ...
  return (
    <div className='mb-20'>
                            ...
                            <div>
                                <div>
                                    ...
                                    <div className='bg-white7 rounded-md px-3 py-2'>
                                        <input type='text' className='bg-transparent text-white88 placeholder:text-white64 outline-none border-none w-full'/>
                                    </div>
                                </div>
                                <div className='mt-3'>
                                ...
                                <div className='mt-3'>
                                    ...
                                    <div className='bg-white7 rounded-md px-3 py-2 flex items-center gap-2'>
                                        ...
                                        <input type='text' placeholder='discord.gg' className='bg-transparent text-white88 placeholder:text-white32 outline-none border-none w-full'/>
                                    </div>
                                </div>
                            </div>
                        </AccordionContent>
                           ...
                           <AccordionItem value={`item-${2}`} key={2} className="border-none">
                               <AccordionTrigger className="text-white48 font-inter hover:no-underline border-b border-primaryYellow">
                                   <div className='flex items-center gap-1'>
                                       ...
                                       <div className='text-primaryYellow font-inter text-[14px]'>{milestone?.title}</div>
                                   </div>
                               </AccordionTrigger>
                               <AccordionContent className="py-2">
                                   <div>
        ...
        <div className='bg-[#091044] px-20 py-4 fixed bottom-0 left-0 w-full flex justify-between items-center'>
            ...
            <div>
                <button className='bg-primaryYellow px-6 py-2 rounded-md text-[14px] font-inter'>Save</button>
            </div>
        </div>
    </div>
  )
